  ...
  export default {
    ...
    methods: {
      async getPayInfo() {
        ...
        const res = await this.$API.reqPayInfo(10552);
        console.log(res)
      },
      // weixin://wxpay/bizpayurl?pr=FmFSw2mzz
      async open() {
        const url = await QRCode.toDataURL('weixin://wxpay/bizpayurl?pr=FmFSw2mzz')
        this.$alert(`<img src=${url} alt="" />`, '微信支付', {
